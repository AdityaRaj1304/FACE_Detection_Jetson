      ...
      <main className="w-full max-w-md px-margin-mobile relative z-10">
        ...
        {!showCard && (
          <button 
            ...
            className="w-full h-16 backdrop-blur-sm bg-gradient-to-r from-white/8 to-white/5 rounded-3xl font-headline-md text-on-surface border border-white/15 hover:from-white/12 hover:to-white/8 active:scale-95 transition-all duration-300 flex items-center justify-center gap-stack-sm animate-in fade-in slide-in-from-bottom-4 duration-700 mt-40"
            style={{
