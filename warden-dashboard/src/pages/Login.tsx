...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-stretch selection:bg-primary-container selection:text-on-primary-container bg-background">
      {/* Left Section: 55% Background Image */}
      <section 
        className="hidden lg:flex lg:w-[55%] relative flex-col items-center justify-center p-margin-desktop overflow-hidden"
        style={{
      ...
      >
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-background/40 via-transparent to-background/20"></div>
      </section>
      ...
      <main className="w-full lg:w-[45%] flex items-center justify-center p-margin-mobile md:p-margin-desktop bg-surface z-10 relative">
        <form onSubmit={handleLogin} className="w-full max-w-md flex flex-col gap-stack-lg animate-in fade-in slide-in-from-right-8 duration-700">
          ...
          <div className="flex flex-col items-center gap-stack-sm mb-stack-sm">
            <div className="w-16 h-16 rounded-2xl glass-md flex items-center justify-center mb-stack-sm">
          ...
          {/* Login Box (Glass UI) */}
          <div className="glass-lg rounded-[32px] p-stack-lg flex flex-col gap-stack-md">
            {/* Email Field */}
            <div className="flex flex-col gap-unit">
              ...
              <div className="relative group">
                <input 
                  className="w-full h-14 px-12 glass-input rounded-xl font-body-md text-on-surface border-none focus:outline-none transition-all placeholder:text-outline" 
                  id="admin_id" 
            ...
            <div className="flex items-center justify-between px-unit mt-2">
              <label className="flex items-center gap-stack-sm cursor-pointer group">
                <div className="w-5 h-5 rounded glass-sm flex items-center justify-center transition-all group-hover:scale-105">
            ...
            {/* Submit Button */}
            <button type="submit" className="mt-stack-sm w-full h-16 glass-button rounded-2xl font-headline-md text-primary hover:scale-[0.98] active:scale-95 transition-all duration-200 group flex items-center justify-center gap-stack-sm">
            ...
            <div className="grid grid-cols-2 gap-stack-md">
              <button type="button" className="h-12 glass-button rounded-xl flex items-center justify-center gap-2 hover:glass-md transition-all active:scale-95">
          ...
          <div className="flex items-center justify-center gap-stack-md opacity-40">
            <div className="flex items-center gap-1">
              <div className="w-2 h-2 rounded-full bg-primary glow-orange animate-pulse"></div>
